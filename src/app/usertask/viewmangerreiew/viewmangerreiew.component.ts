...
@Component({
  selector: 'app-viewmangerreiew',
  templateUrl: './viewmangerreiew.component.html',
  styleUrls: ['./viewmangerreiew.component.css'],
  providers: [Usertaskservice, NotificationsComponent, dateFormatPipe]
})
export class ViewMangerReviewComponent implements OnInit {



  btnBool: boolean;
  selectControl: FormControl = new FormControl()
  popupcontrol: FormControl = new FormControl()
  ...
  constructor(private usertaskservice: Usertaskservice,
    ...
    private dateformat: dateFormatPipe, private router: Router) { }
  ...
  viewReviewPop(openRemModal1, taskId) {
    this.taskId = taskId;
    if (openRemModal1 == openRemModal1) {
      this.open1(openRemModal1);
    }
    else {
      return;
    }
  ...
  open1(openRemModal1) {
    ...
    this.modalService.open(openRemModal1, ngbModalOptions).result.then(
  ...
  viewUserTask() {
    ...
    var frmdata1 = {
      ...
      branchrefid: this.selobj.branchid, employeeid: sessionStorage.getItem('indvuserid')
    };
