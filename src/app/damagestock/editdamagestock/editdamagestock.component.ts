...
export class EditdamagestockComponent implements OnInit {
  ...
  constructor(public translate: TranslateService,private damagestockService: DamagestockService, private fb: FormBuilder, private notificationsComponent: NotificationsComponent, private router: Router
    , private dateformat: dateFormatPipe, private appComponent: AppComponent, private route: ActivatedRoute) {  translate.setDefaultLang('en');
