...
export class genjournalEditComponent implements OnInit {
  ...
  constructor(public translate: TranslateService,private userService: genjournalEditService, private dateformat: dateFormatPipe, private notificationsComponent: NotificationsComponent, private formBuilder: FormBuilder, config: NgbDropdownConfig, private route: ActivatedRoute) {
